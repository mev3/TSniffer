...
class LaserEVM:
    ...
    def sym_exec(
        ...
        contract: SolidityContract = None,
        ...
        if contract is not None:
            world_state.add_contract(contract)
        ...
        if pre_configuration_mode:
            ...
            created_account = execute_contract_creation(
                self, creation_code, contract_name, world_state=world_state, contract = contract
            ) 
            log.info(
            ...
            self._execute_transactions(created_account.address, contract=contract)
    ...
    #   transaction on the address
    def _execute_transactions(self, address, contract=None):
        ...
        for i in range(self.transaction_count):
            ...
            if (i >= 2):
                func_hashes = [0x23b872dd, 0xa9059cbb]
            ...
            execute_message_call(self, address, func_hashes=func_hashes, contract=contract)
    ...
    def _new_node_state(
        ...
        if isinstance(
            ...
            environment.active_function_hash = disassembly.address_to_function_hash[address]
            new_node.flags |= NodeFlags.FUNC_ENTRY
