...
def execute_message_call(
    laser_evm, callee_address: BitVec, func_hashes: List[List[int]] = None, contract:SolidityContract = None 
) -> None:
...
def execute_contract_creation(
    ...
    for open_world_state in open_states:
        ...
        _setup_global_state_for_execution(laser_evm, transaction, contract=contract)
